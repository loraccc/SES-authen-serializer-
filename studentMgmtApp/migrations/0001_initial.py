    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visited_at', models.DateTimeField(default=datetime.datetime(2023, 11, 27, 12, 28, 45, 317666))),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentMgmtApp.course')),
            ],
            options={
