"""
Django settings for studentMgmtProj project.
...
SECRET_KEY = 'django-insecure-bd-l6@(^ucdm_^f4$ioq9y8r#)vq=ps@@vj8t9-uk3wvwo207n'
...
WSGI_APPLICATION = 'studentMgmtProj.wsgi.application'
